...
module.exports = {
  ...
  deploy: {
    production: {
      ...
      repo: DEPLOY_REP,
      path: DEPLOY_PATH,
      'pre-deploy-local': `scp -Cr .env ${DEPLOY_USER}@${DEPLOY_HOST}:${DEPLOY_PATH}/backend/shared`,
      'pre-deploy': `cp ${DEPLOY_PATH}/backend/shared/.env ${DEPLOY_PATH}/backend/current/.env`,
